...
class UserController extends Controller
{
    ...
    {
        return response()->json($user->load(['position', 'programs', 'permissions']));
    }
    ...
    public function grantPermission(GrantPermissionRequest $request, User $user): JsonResponse
    {
    ...
    public function revokePermission(GrantPermissionRequest $request, User $user): JsonResponse
    {
