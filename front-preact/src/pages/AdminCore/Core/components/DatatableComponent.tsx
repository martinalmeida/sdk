    ...
    <div class="flex flex-col gap-3">
      ...
      <div class="relative w-full max-w-xs">
        ...
        <input
          ...
          class="w-full rounded-lg border border-stone-200 bg-white py-1.5 pl-8 pr-3 text-[13px] text-stone-700 placeholder:text-stone-400 focus:border-[#7c3aed] focus:outline-none focus:ring-1 focus:ring-[#7c3aed]/30"
        />
      </div>
      ...
      <div class="flex items-center justify-between text-[12px] text-stone-400">
        ...
        <div class="flex items-center gap-1">
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1)
            ...
            .map((p, i) =>
              p === "..." ? (
                <span key={`ellipsis-${i}`} class="px-1">
                  …
                </span>
              ) : (
                <button
